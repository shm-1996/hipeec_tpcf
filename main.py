...
def pipeline_galaxy(galaxy_name,method='masked',
    outdir=None,overwrite=False,plot=False,fit=True):
    """
    ...
    saveObj(galaxy_class,galaxy_class.outdir+'/{}_summary'.format(galaxy_name))
    ...
    if(plot):
        ...
        pl.plot_TPCF(save=True,function=None,age='both',omega1=True,
            filename=pl.galaxy.outdir+'/{}_YoungOld_TPCF.pdf'.format(galaxy_name))
        pl.plot_TPCF(save=True,function=None,age=None,omega1=True,
            filename=pl.galaxy.outdir+'/{}_All_TPCF.pdf'.format(galaxy_name))
    saveObj(galaxy_class,galaxy_class.outdir+'/{}_summary'.format(galaxy_name))

    # galaxy_class.fit_TPCF(method='mcmc',function='singletrunc',age='young',plot=plot)
    # galaxy_class.fit_TPCF(method='mcmc',function='singletrunc',age='old',plot=plot)
